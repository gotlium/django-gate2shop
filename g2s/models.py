...
class G2STransaction(models.Model):
    ...
    AuthCode = models.PositiveIntegerField(null=True, blank=True)
    ...
    cardCompany = models.CharField(max_length=255)
